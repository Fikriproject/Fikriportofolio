    ...
    return (
        <nav
            className={`fixed w-full top-0 z-50 transition-all duration-500 ${isOpen
                    ? "bg-[#0B0F17]"
                    : scrolled
                        ? "bg-[#0B0F17]/75 backdrop-blur-xl border-b border-slate-800/60"
                        : "bg-transparent"
                }`}
        >
                ...
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="flex-shrink-0">
                        <a
                            ...
                            className="text-xl font-bold bg-gradient-to-r from-[#06b6d4] to-[#2563eb] bg-clip-text text-transparent"
                        >
                            Fikri Ali Projects
                        </a>
                    </div>
                        ...
                        <div className="ml-8 flex items-center space-x-8">
                            {navItems.map((item) => (
                                ...
                                >
                                    ...
                                    <span
                                        className={`absolute bottom-0 left-0 w-full h-0.5 bg-gradient-to-r from-[#2563eb] to-[#06b6d4] transform origin-left transition-transform duration-300 ${activeSection === item.href.substring(1)
                                                ? "scale-x-100"
            ...
            <div
                className={`md:hidden transition-all duration-300 ease-in-out ${isOpen
                        ? "max-h-screen opacity-100 bg-[#0B0F17]/95 border-b border-slate-800"
