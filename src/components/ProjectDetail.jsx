...
const ProjectDetails = () => {
  ...
  const projectUrl = `https://www.fikriproject.my.id/project/${toSlug(project.Title)}`;

  return (
    <>
      <Helmet>
        <title>{project.Title} — Muchamad Fikri Ali</title>
        <meta
          name="description"
          content={
            project.Description
              ? project.Description.slice(0, 155)
              : `Project ${project.Title} oleh Muchamad Fikri Ali — Embedded Systems & Web Development.`
          }
        />
        ...
        <meta
          property="og:title"
          content={`${project.Title} — Muchamad Fikri Ali`}
        />
        <meta
              ...
              <div className="space-y-6 md:space-y-10 animate-slideInLeft">
                <div className="space-y-4 md:space-y-6">
                  <div className="flex flex-wrap items-center gap-3">
                    ...
                    {project.Year && (
                      <span className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl text-sm font-semibold bg-cyan-500/15 text-cyan-300 border border-cyan-500/30 backdrop-blur-md shadow-lg">
